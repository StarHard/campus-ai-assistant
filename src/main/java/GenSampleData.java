...
public class GenSampleData {
    ...
    static void genStudents(String dir) throws Exception {
        ...
        String[][] data = {
            ...
            {"2024008","郑十","女","13800001008","zhengshi@qq.com","数学学院","统计","2024"},
    ...
    static void genCourses(String dir) throws Exception {
        ...
        String[][] data = {
            {"CS101","数据结构","T1001","王老师","计算机学院","4","64","48","16","1","1","2024-2025-1","经典数据结构课程，涵盖线性表、树、图等"},
            {"CS102","操作系统","T1002","李老师","计算机学院","4","64","48","16","1","1","2024-2025-1","操作系统原理，进程管理、内存管理等"},
            {"CS103","计算机网络","T1003","张老师","计算机学院","3","48","36","12","1","2","2024-2025-1","TCP/IP协议、网络拓扑、路由等"},
            {"CS104","数据库原理","T1004","赵老师","计算机学院","3","48","36","12","2","1","2024-2025-1","关系数据库、SQL、范式理论"},
            {"CS105","Java程序设计","T1005","钱老师","计算机学院","4","64","32","32","2","3","2024-2025-1","面向对象编程、集合框架、多线程"},
            {"EE201","信号与系统","T2001","周老师","电子信息学院","3","48","40","8","1","1","2024-2025-1","连续与离散信号分析"},
            {"EE202","数字电路","T2002","吴老师","电子信息学院","3","48","36","12","2","1","2024-2025-1","组合逻辑与时序逻辑电路"},
            {"MA301","高等数学","T3001","郑老师","数学学院","5","80","80","0","1","2","2024-2025-1","微积分、级数、微分方程基础"},
            {"MA302","线性代数","T3002","冯老师","数学学院","3","48","48","0","2","1","2024-2025-1","矩阵论、向量空间、特征值"},
            {"EN401","大学英语","T4001","陈老师","外国语学院","4","64","48","16","1","2","2024-2025-1","英语读写与口语综合"},
        };
